<a name="main"></a>
# Kensho - Individual Contributor - Machine Learning Engineering
|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | -- |
| Technical Excellence <ul><li>Tools and Tech</li><li>Technical Problem Solving</li><li>Architecture</li><li>Implementation and Forethought</li><li>Code/Design Review</li><li>Debugging</li></ul> | [Machine Learning Engineer I](#mle1_techexc) | [Machine Learning Engineer II ](#mle2_techexc)  | [Senior Machine Learning Engineer I](#smle1_techexc) | [Senior Machine Learning Engineer II](#smle2_techexc)  | [Staff Machine Learning Engineer](#staff_techexc) | [Principal Machine Learning Engineer](#principal_techexc)  |
| Leadership <ul><li>Intellectual Curiosity</li><li>Innovation</li><li>Decision Scope</li><li>Operational Capacity</li><li>Collaboration Sphere</li><li>Conflict Resolution</li><li>Self-Development</li><li>Adaptability</li><li>Judgement</li><li>General Problem Solving</li></ul>| [Machine Learning Engineer I](#mle1_leadership) | [Machine Learning Engineer II ](#mle2_leadership) | [Senior Machine Learning Engineer I](#smle1_leadership) | [Senior Machine Learning Engineer II](#smle2_leadership) | [Staff Machine Learning Engineer](#staff_leadership) | [Principal Machine Learning Engineer](#principal_leadership)| 
| Autonomy<ul><li>Bias to Action</li><li>Influence on Work</li><li>Resourcefulness</li><li>Delegation</li><li>Prioritization</li></ul>| [Machine Learning Engineer I](#mle1_autonomy) | [Machine Learning Engineer II ](#mle2_autonomy)  | [Senior Machine Learning Engineer I](#smle1_autonomy)  | [Senior Machine Learning Engineer II](#smle2_autonomy)  | [Staff Machine Learning Engineer](#staff_autonomy)  | [Principal Machine Learning Engineer](#principal_autonomy)  |
| Teamwork <ul><li>Feedback</li><li>Communication</li><li>Participation</li><li>Go Team</li></ul> | [Machine Learning Engineer I](#mle1_teamwork) | [Machine Learning Engineer II ](#mle2_teamwork) | [Senior Machine Learning Engineer I](#smle1_teamwork) | [Senior Machine Learning Engineer II](#smle2_teamwork) | [Staff Machine Learning Engineer](#staff_teamwork) | [Principal Machine Learning Engineer](#principal_teamwork) |
...
<a name="mle1_techexc"></a>
### Technical Excellence
###### [Jump to top](#main)
 
 |  |  |
 | --- | --- |
 | **Tools and Tech** | Understands most processes and principles and is familiar with the essential technologies for their work (e.g. git, python, PyTorch, scikit-learn, numpy, pandas, etc.); relies on reference documentation as needed to develop their understanding of core technologies.|
 | **Technical Problem Solving** | Able to follow instructions and deliver results with minimal guidance, troubleshoots and finds solutions autonomously. Explores multiple solutions before zeroing in on one. Proactively brings up issues when help is needed and drives resolution within a reasonable time frame. |
 | **Implementation and Forethought** | Implementations perform as specified under typical conditions. Able to convert notebooks into scripts; solutions are implemented efficiently, no redundant code or copy paste. Pays attention to design, reuses existing functions/libraries, provides clean documentation (within and outside of the code base). |
...
<a name="smle1_techexc"></a>
### Technical Excellence
###### [Jump to top](#main)
| | | 
| -- | -- |
 | **Tools and Tech** | Deeply experienced with all essential technologies for their role. Understands end-2-end ML lifecycle and is able to quickly diagnose ML-related issues, pinpoint problematic areas and design and implement solutions autonomously. Recognized as a team expert on particular tools and/or technologies. Employs unfamiliar reference documentation efficiently and judiciously for atypical use of technologies.  |
| **Technical Problem Solving** | Independently develops and deploys features across an entire ML application; understands inter-dependencies and how a single change might affect multiple components. Able to autonomously design, build and deploy an ML-based solution. Incorporates new/unfamiliar frameworks with ease after initial research and evaluation. Helps team resolve complex technical problems.  |
| **Architecture** | Evaluate tradeoffs between complexity, memory usage, performance, reliability, and suitability for product goals and makes recommendations with strong justifications of choices. Explores multiple approaches before zeroing in on one. Able to think beyond own scope and how ML solution will be incorporated into an end application. Works with software engineering teams to fine-tune and refine relevant architectural choices. |
| **Implementation** | Abnormal behavior from dependencies is handled when possible; observables (e.g. logs and metrics) highlight actionable problems with the system. Designs and implements complex solutions with multiple dependencies. Ensures code is well tested with high test coverage. *Scope is primarily within own project.*|
| **Code/Design Review** | Provides thorough, timely code reviews. Sought out as a reviewer for more complicated changes affecting an application. Provides feedback on all areas of design docs. Proactively pinpoints areas of concern or potential risk and mitigates those risks with timely solutions. Attentive to detail. Champions best practices in security and data privacy. |
